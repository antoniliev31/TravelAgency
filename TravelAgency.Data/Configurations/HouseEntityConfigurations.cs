namespace TravelAgency.Data.Configurations
{
    ...
    public class HouseEntityConfigurations : IEntityTypeConfiguration<House>
    {
        ...
        private House[] GenerateHouses()
        {
            ...
            //string[] imageFiles = Directory.GetFiles("път_до_директорията_със_снимките");

            //// Генерирайте линкове за всяка снимка и ги добавете към къщата
            //foreach (string imageFile in imageFiles)
            //{
            //    string imageUrl = "път_до_директорията_със_снимките/" + Path.GetFileName(imageFile);
