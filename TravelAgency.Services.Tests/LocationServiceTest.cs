namespace TravelAgency.Services.Tests
{
    ...
    public class LocationServiceTest
    {
        ...
        [Test]
        public async Task CreateLocationAsync_ShouldCreateNewLocation()
        {
            string locationName = "New Location";
            var locationService = new LocationService(context);

            await locationService.CreateLocationAsync(locationName);

            bool locationExists = await context.Locations.AnyAsync(l => l.Name == locationName);
